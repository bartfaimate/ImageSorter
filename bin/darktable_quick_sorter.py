...
sys.path.append(Path(__file__).resolve().parents[1].joinpath('lib'))

from typing import Union, List
import shutil
from datetime import datetime as dt

from lib.darktable.darktable import Darktable
from lib.darktable.constants import basic_xml_fmt
